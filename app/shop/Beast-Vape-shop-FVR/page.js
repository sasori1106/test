...
export default function BeastVapeShopFVR() {
  ...
  const products = [
    ...
    { name: "X-Vape X6 Series Transparent Tropical Storm", price: 399.99, stock: 30, img: "/x6-orange.jpg" },
    { name: "X-Vape X5 Series Polar Glacier", price: 449.99, stock: 30, img: "/x3-blue.jpg" },
  ];
      ...
      <section className="bg-[#e6d5cc] p-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-3xl font-bold text-neutral-900">Beast Vape Shop - FVR</p>
            <p className="text-sm text-green-600">Location: Sampol FVR, San Jose del Monte, Bulacan</p>
          </div>
          <div>
