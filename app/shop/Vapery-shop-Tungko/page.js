...
export default function VaperyShopTungko() {
  ...
  const products = [
    { name: "X-1 Series Pink Air", price: 550.00, stock: 15, img: "/x-pink.jpg" },
    { name: "Demon Vape Series", price: 599.00, stock: 8, img: "/demon.jpg" },
    { name: "Vookbar 13,000 Puffs", price: 730.00, stock: 25, img: "/vookbar.jpg" },
    { name: "X-Vape x6 Series", price: 650.00, stock: 30, img: "/x6-black.jpg" },
    { name: "X-Vape X6 Series Transparent Chamber", price: 800.0, stock: 30, img: "/x6-glass.jpg" },
    { name: "X-Vape X3 Series Transparent Chamber", price: 650.00, stock: 30, img: "/x3-green.jpg" },
    { name: "X-Vape X6 Series Transparent Tropical Storm", price: 14.99, stock: 30, img: "/x6-orange.jpg" },
    { name: "X-Vape X5 Series Polar Glacier", price: 14.99, stock: 30, img: "/x3-blue.jpg" },
  ];
      ...
      <section className="bg-[#e6d5cc] p-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-3xl font-bold text-neutral-900">Vapery Vape Shop - Tungko</p>
            <p className="text-sm text-green-600">Location: Tungko San Jose del Monte, Bulacan</p>
          </div>
          <div>
