...
export default function BeastVapeShopGayaGaya() {
  ...
  const products = [
    { name: "Nasty Pod", price: 550.00, stock: 15, img: "/nasty-pod.jpg" },
    { name: "Blu Bar Vape", price: 599.00, stock: 8, img: "/blu2.jpg" },
    { name: "Nasty 15,000 puff kits", price: 730.00, stock: 25, img: "/nasty.jpg" },
    { name: "OXVA Slim", price: 650.00, stock: 30, img: "/oxva.jpg" },
      ...
      <section className="bg-[#e6d5cc] p-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-3xl font-bold text-neutral-900">Beast Vape Shop - Gaya-Gaya</p>
            <p className="text-sm text-green-600">Location: Gaya-Gaya, San Jose del Monte, Bulacan</p>
          </div>
          <div>
